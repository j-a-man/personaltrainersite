            ...
            <section className="py-24 relative bg-zinc-900 border-t border-white/5">
                ...
                <div className="px-6 md:px-8 space-y-32 max-w-7xl mx-auto relative z-10">
                    <CaseStudyCard
                        ...
                        story="I tried everything—keto, paleo, crossfit. Nothing stuck because it didn't fit my 60-hour work week. The Universal Fitness protocol wasn't just a workout plan; it was a lifestyle design. I'm eating more than ever and dropping dress sizes."
